...
def make_args():
    ...
    parser.add_argument('--train_file', type=str, default="adapted_data/Edin/traj_train.csv")
    parser.add_argument('--valid_file', type=str, default="adapted_data/Edin/traj_valid.csv")
    parser.add_argument('--test_file', type=str, default="adapted_data/Edin/traj_test.csv")
    parser.add_argument('--edges_shp', type=str, default="adapted_data/Edin/map/edges.shp")
    # parser.add_argument('--workspace', type=str, default="data/pt_data")
    # parser.add_argument('--train_file', type=str, default="data/pt_data/traj_train_20.csv")
    # parser.add_argument('--valid_file', type=str, default="data/pt_data/traj_valid.csv")
    # parser.add_argument('--test_file', type=str, default="data/pt_data/traj_test.csv")
    # parser.add_argument('--edges_shp', type=str, default="data/pt_data/map/edges.shp")
